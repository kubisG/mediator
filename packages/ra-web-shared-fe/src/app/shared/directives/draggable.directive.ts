import { OnInit, Directive, ElementRef, NgZone, OnDestroy, ChangeDetectorRef } from "@angular/core";
...
export class DraggableDirective implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    // handle just the header
    this._handle = this._elementRef.nativeElement;
//    this._handle = this._elementRef.nativeElement.parentElement.parentElement;
