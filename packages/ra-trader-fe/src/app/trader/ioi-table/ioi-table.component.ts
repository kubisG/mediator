import {
    ...
    ComponentFactoryResolver, Injector, ApplicationRef, Inject
} from "@angular/core";
...
import { TraderIoiService } from "./trader-ioi.service";
...
import { DockableComponent, Dockable, DataExchangeService, LayoutRights, DockableHooks } from "@ra/web-components";
...
@Component({
    selector: "ra-ioi-table",
    templateUrl: "./ioi-table.component.html",
    styleUrls: ["./ioi-table.component.less"],
})
export class IoiTableComponent extends DockableComponent implements OnInit, DockableHooks {
    private dataGrid;
    public lists;
    ...
    constructor(
        private ioiService: TraderIoiService,
    ...
    openDialog(data?, action?: string): void {
        ...
        if (action === "C") {
            ...
            const dialogRef = this.dialog.open(IoiDialogComponent, {
                width: "70%",
