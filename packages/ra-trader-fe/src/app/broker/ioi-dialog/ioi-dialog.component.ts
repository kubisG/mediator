...
@Component({
    selector: "ra-broker-ioi-dialog",
    templateUrl: "./ioi-dialog.component.html",
    styleUrls: ["./ioi-dialog.component.less"]
})
export class IoiBrokerDialogComponent implements OnInit, OnDestroy {
    ...
    public ioiForm: FormGroup = new FormGroup({
        ...
        Price: new FormControl({
            value: null, disabled:
                ((this.data.data.Canceled === "Y") || ((this.data.data.Type === IOIType.Incoming) && (this.data.action !== "E")))
        ...
        ConfirmTo: new FormControl({
            value: null, disabled:
                ((this.data.data.Canceled === "Y") || (this.data.action === "R"))
        }),
    ...
    constructor(
        public dialogRef: MatDialogRef<IoiBrokerDialogComponent>,
        ...
        if ((this.data.data.Canceled === "Y") || ((this.data.data.Type === IOIType.Incoming) && (this.data.action !== "E"))) {
